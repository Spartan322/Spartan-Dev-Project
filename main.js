...
var Companies, JobApplicants, SDP, __notificationRep,
...
SDP.Util.Enum = (function() {
  ...
  Enum.prototype.consturctor = function() {
    var i, j, k, len, len1, name, ref, results1, v, values;
    ...
    for (k = 0, len1 = ref.length; k < len1; k++) {
      v = ref[k];
      results1.push(this[v.name] = v.value);
    }
    return results1;
  };
